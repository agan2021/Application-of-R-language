...
教学目的：  
          ...
          1.熟悉金融计量软件的种类；  
          2.了解各种金融计量软件的特点；  
          3.掌握金融计量软件使用范围以及编程基础特点。  
教学重难点：  
        
         1.重点：掌握金融计量软件使用范围以及编程基础特点；  
         2.难点：了解各种金融计量软件的特点；  
...
计量经济学是将经济理论实用化、数理化的实证经济学。它是利用经济理论、数学、统计推断等工具对经济现象进行分析的经济学科的分支。  　　
...
![金融计量建模流程](J:\imag\pic1.png)

## 经济与金融模型中的数据

1.经济与金融数据的类型

+ 横截面数据：同一时间在不同空间的观测数据
+ 时间序列数据：按时间序列排列的数据
+ 面板数据：时间序列数据和横截面数据相结合的数据
...
教学目的：  
          ...
          1.熟悉参数估计与假设检验的理论知识；  
          2.了解R软件参数估计与各类假设检验的流程；  
          3.掌握各类参数估计与各类假设检验的编程基础特点。  
教学重难点：  
        
         1.重点：掌握各类参数估计与各类假设检验的R语言应用编程特点；  
         2.难点：了解各类参数估计与各类假设检验的R语言应用流程；  
...
教学目的：  
          ...
          1.熟悉线性回归的定义以及约束条件；  
          2.了解线性回归模型的R语言编程汇编语言；  
          3.掌握线性回归模型的R语言编程的关键问题的解决。  
教学重难点：  
        
         1.重点：掌握线性回归模型的R语言编程的关键问题的解决；  
         2.难点：了解线性回归模型的R语言编程汇编语言；  
...
教学目的：  
          ...
          1.熟悉多重共线性的定义；  
          2.掌握多重共线性的理论知识；  
          3.掌握多重共线性的控制条件在R语言上的编程。  
教学重难点：  
        
         1.重点：掌握多重共线性的控制条件在R语言上的编程；  
         2.难点：了解多重共线性的控制条件；  
...
教学目的：  
          ...
          1.熟悉时间序列的定义以及ARIMA模型的适用条件；  
          2.了解时间序列与ARIMA模型的逻辑特点；  
          3.掌握时间序列与ARIMA模型在R语言编程上的特点。  
教学重难点：  
        
         1.重点：掌握时间序列与ARIMA模型在R语言编程上的特点；  
         2.难点：了解时间序列与ARIMA模型的逻辑特点；  
## 单位根检验
...
# 第十章 时间序列分析garch模型的R语言应用 
教学目的：  

          1.熟悉时间序列的定义以及GARCH模型的适用条件；  
          2.了解时间序列与GARCH模型的逻辑特点；  
          3.掌握时间序列与GARCH模型在R语言编程上的特点。  
教学重难点：  
        
         1.重点：掌握时间序列与GARCH模型在R语言编程上的特点；  
         2.难点：了解时间序列与GARCH模型的逻辑特点；  
